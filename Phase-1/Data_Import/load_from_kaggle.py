...
trips_data = [data_2024_01, data_2024_02, data_2024_03, data_2024_04, data_2024_05, data_2024_06, data_2024_07]
...
borough_df[['ID', 'Borough', 'Zone']].to_csv('C:\\Big_data_group_project\\processed_data\\borough_info.csv', index=False)
...
ratecode_df.to_csv('C:\\Big_data_group_project\\processed_data\\ratecode_info.csv', index=False)
...
payment_df.to_csv('C:\\Big_data_group_project\\processed_data\\payment_info.csv', index=False)
...
vendor_df.to_csv('C:\\Big_data_group_project\\processed_data\\vendor_info.csv', index=False)


# clear the time_info.csv and trip_info.csv
open('C:\\Big_data_group_project\\processed_data\\time_info.csv', 'w').close()
open('C:\\Big_data_group_project\\processed_data\\trip_info.csv', 'w').close()
...
for trip in trips_data:
    ...
    time_df.to_csv('C:\\Big_data_group_project\\processed_data\\time_info.csv', mode='a', header=header_bool, index=False)
    ...
    trip_df = data_df[['TripID', 'passenger_count', 'trip_distance', 'store_and_fwd_flag', 'fare_amount', 'extra', 'mta_tax', 'improvement_surcharge',
                    'tip_amount', 'tolls_amount', 'total_amount', 'congestion_surcharge', 'Airport_fee', 'VendorID', 'payment_type', 'RatecodeID', 
                    'PULocationID', 'DOLocationID']].rename(columns={
                                                            'TripID': 'ID',
    ...
    trip_df.to_csv('C:\\Big_data_group_project\\processed_data\\trip_info.csv', float_format='%.0f', mode='a', header=header_bool, index=False)
