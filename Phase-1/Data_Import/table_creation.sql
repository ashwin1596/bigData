...
\copy location FROM C:\Big_data_group_project\processed_data\borough_info.csv CSV DELIMITER ',' HEADER;

-- Load data into RateCode table
\copy ratecode FROM C:\Big_data_group_project\processed_data\ratecode_info.csv CSV DELIMITER ',' HEADER;

-- Load data into Payment table
\copy payment FROM C:\Big_data_group_project\processed_data\payment_info.csv CSV DELIMITER ',' HEADER;

-- Load data into Vendor table
\copy vendor FROM C:\Big_data_group_project\processed_data\vendor_info.csv CSV DELIMITER ',' HEADER;

-- Load data into Time table
\copy time FROM C:\Big_data_group_project\processed_data/time_info.csv CSV DELIMITER ',' HEADER;

-- Load data into Trip table
\copy trip FROM C:\Big_data_group_project\processed_data/trip_info.csv CSV DELIMITER ',' HEADER;
